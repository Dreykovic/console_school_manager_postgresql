...
class TableEleve(TablePersonne):
    ...
    def __init__(self,  tuteur, classe, nom=None, prenom=None, date_naissance=None, contact=None, genre=None, adresse=None):
...
def main():
    ...
    tut = TableEleve(1,1,"Dosseh", "OOO", datenaiss, "70546987",
                      "M", "BP 25 Sok")
    tut.create()
