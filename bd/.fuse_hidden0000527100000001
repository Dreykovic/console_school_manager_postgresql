...
CREATE TABLE class (go integer PRIMARY KEY);

CREATE TABLE test (id_classe serial NOT NULL, nom varchar UNIQUE ,effectif integer NOT NULL UNIQUE ,CONSTRAINT id_classe_pk PRIMARY KEY(id_classe), CONSTRAINT effectif_fk FOREIGN KEY (effectif) REFERENCES class (go));